...
public class StatusProvider extends ContentProvider {
    ...
    public Cursor query(@NonNull Uri uri, @Nullable String[] projection,
        ...
        Cursor cursor = db.query(StatusContract.TABLE, projection,
                where, selectionArgs, null, null, orderBy);
    ...
    public String getType(@NonNull Uri uri) {
        switch (sURIMatcher.match(uri)) {
            case StatusContract.STATUS_DIR:
                Log.d(TAG, "gotType: vnd.android.cursor.dir/vnd.com.example.yamba.provider.status");
                return "vnd.android.cursor.dir/vnd.com.example.yamba.provider.status";
            case StatusContract.STATUS_ITEM:
                Log.d(TAG, "gotType: vnd.android.cursor.item/vnd.com.example.yamba.provider.status");
                return "vnd.android.cursor.item/vnd.com.example.yamba.provider.status";
            default:
                throw new IllegalArgumentException("uri incorrecta: " + uri);
        }
    }
